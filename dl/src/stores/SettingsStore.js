...
const CORE_ASSET = "REX"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "cn",
            connection: "wss://client.rexledger.com/ws",
            faucet_address: "https://services.rexledger.com",
            unit: CORE_ASSET,
            // showSettles: false,
        ...
        this.preferredBases = Immutable.List([CORE_ASSET, "CNY"]);
        this.baseOptions = [CORE_ASSET, "CNY"];

        this.starredMarkets = Immutable.Map([

            // REX BASE
            ["CHAINB_"+ CORE_ASSET, {"quote": "CHAINB","base": CORE_ASSET}],
            ["CNY_"+ CORE_ASSET, {"quote": "CNY","base": CORE_ASSET}],

            // CNY BASE
            ["CHAINB_CNY", {"quote": "CHAINB","base": "CNY"}],
            [CORE_ASSET + "_CNY", {"quote": CORE_ASSET,"base": "CNY"}],

            // OTHERS
            [CORE_ASSET+"_CHAINB", {"quote": CORE_ASSET, "base": "CHAINB"}],
            ["CNY_CHAINB", {"quote": "CNY","base": "CHAINB"}]
        ...
        this.defaults = {
            ...
            connection: [
                "wss://client.rexledger.com/ws",
                // "wss://rexsh.rexledger.com/ws",
                // "wss://rexbj.rexledger.com/ws"
            ],
            unit: [
                CORE_ASSET,
                "CNY",
